...
<?php
echo 'Cart Count: ' . wc_get_cart_contents_count();
?>

<?php if ( wc_get_cart_contents_count() === 0 ) : ?>
<div class="empty-cart-message">
    <p><?php esc_html_e( 'Your cart is currently empty.', 'your-text-domain' ); ?></p>
    <p><a class="button"
            href="<?php echo esc_url( wc_get_shop_url() ); ?>"><?php esc_html_e( 'Continue Shopping', 'your-text-domain' ); ?></a>
    </p>
</div>
<?php else : ?>
...
<form class="woocommerce-cart-form container" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
    ...
    <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents container" cellspacing="0">
        <thead>
            <tr>
